// Package application_design_test // Package application_design_test Ниже реализован сервис бронирования номеров в отеле. В предметной области
...
package application_design_test
...
//}
//
//var Availability = []RoomAvailability{ //nolint
...
//	err := http.ListenAndServe(":8080", mux) //nolint
...
//	var newOrder Order
//	json.NewDecoder(r.Body).Decode(&newOrder) //nolint
//
...
//	json.NewEncoder(w).Encode(newOrder) //nolint
//
